...
TaskHandle_t menuTaskHandle, ButtonTaskHandle, bootTaskHandle;
TaskHandle_t SnakeTaskHandle, systemTaskHandle, i2cOwnerTask, IdleCalibrateTaskHandle;
